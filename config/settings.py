...
MIDDLEWARE = [
    ...
    # 'config.middleware.BlockUserIpAddressMiddleware',
]
...
DATABASES = {
    'default': {
        ...
        'HOST': os.environ.get('POSTGRES_HOST', '134.122.48.245')
    }
}
...
SIMPLE_JWT = {
    ...
    "TOKEN_OBTAIN_SERIALIZER": "account.api.serializers.UserTokenPairSerializer",
}
